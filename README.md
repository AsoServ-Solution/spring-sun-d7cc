...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/spring-asoserv#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-asoserv
```

A live public deployment of this template is available at [https://spring-asoserv.templates.workers.dev](https://spring-asoserv.templates.workers.dev)
